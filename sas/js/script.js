         ...
         for(let j of sve){
           ...
           let color;
            if(i.role == '1'){
             ...
             <div class="col-6  p-0" id="sakrijPrikaziNapomenu${i.id}">
             <button class="btn btn-primary btn-sm" id="createNapomenaAdmin${i.id}" style="width:80%;" onclick="createNapomenaAdmin(${i.id})">Opis</button>
             </div>
             <div class="col-6 p-0">
             <button class="btn btn-danger btn-sm" style="width:80%;" onclick="proslediIdBrisanje(${i.id})">Obrisi</button>
             </div>
             </div>
             <hr>
             `;
